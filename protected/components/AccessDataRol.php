     ...
     public function getItems(){
        ...
        foreach($roles as $rol){
            if($rol == 'Guest'){
                ...
                $operationsDenied = array('Update','View','Delete','Index','asignaservicio','GetReporteCaja','GetTecnicos','GetTecnicoInforme','asignService','GetServiciosGrid','SearchClient','GetServicioProcesos','GetHistorial');
                foreach ($tasks as $task){
                    $operations = Authitemchild::model()->findAll("parent='".$task->child."'");
